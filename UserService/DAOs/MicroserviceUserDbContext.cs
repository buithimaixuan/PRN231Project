...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
            => optionsBuilder.UseSqlServer("Data Source=DESKTOP-CTS44AC\\MAIN;Initial Catalog=Microservice_UserDB;User Id=sa;Password=0789616573;MultipleActiveResultSets=true;Encrypt=false;Connection Timeout=10000");

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Account>(entity =>
            {
                entity.HasKey(e => e.AccountId).HasName("PK__Account__46A222CDC31C4D41");

                entity.ToTable("Account");

                entity.HasIndex(e => e.Username, "UQ__Account__F3DBC572A5689F65").IsUnique();
            ...
            {
                entity.HasKey(e => e.RequestId).HasName("PK__FriendRe__18D3B90F6585A13D");
            ...
            {
                entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CCC2D7B4FC");
